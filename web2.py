...
model_dict = {
    ...
    "Logistic Regression with Degree = 2": joblib.load("lr.pkl")
}
scaler = joblib.load("scaler.pkl")  
poly2 = joblib.load("poly2_transform.pkl")
...
if st.button("📊 Dự đoán"):
    ...
    if model_name == "Logistic Regression with Degree = 2":
        input_scaled = poly2.transform(input_scaled)    
